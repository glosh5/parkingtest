              ...
              <table class="table table-hover mb-0">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>{{$park['checkin']}}</td>
                    <td>{{$park['checkout']}}</td>
                        @if($park['status'] == 'checkedout')
                    <td><span class="badge bg-success">{{$park['status']}}</span></td>
                        @endif
                        @if($park['status'] == 'pending')
                        <td><span class="badge bg-denger">{{$park['status']}}</span></td>
                            @endif
                    <td>{{$park['owner']}}</td>
                    <td>{{$park['recordedBy']}}</td>
                  </tr>
                  @endforeach
